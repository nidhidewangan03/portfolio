  ...
  return (
    <div className ='container about-page'>
      <div className='text-zone'>
        ...
        <div  id='about-para'>
          <p> I am a passionate learner with a keen interest in designing and frontend development.
      ...
      <div id='about-img'>
        <img src={Image} style={{ height: '80vh', width: '70vh', opacity:'1'}} alt="img-about" />
      </div>
    </div>
  );
}
